'''
 # @ Author: @iamlu-coding - https://github.com/iamlu-coding/python-sharepoint-office365-api/tree/main
 # @ Create Time: 2024-02-02 18:37:40
 # @ Modified time: 2024-02-02 18:43:00
 # @ Description: 
 
    This file contains the class for Office365 API. This class will be used to interact with the Office365 API.
    This class is reused from https://github.com/iamlu-coding/python-sharepoint-office365-api/tree/main
...
SHAREPOINT_DOC = env('sharepoint_document_library')
